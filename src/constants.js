export const techStack = [
  // 🌐 Frontend
  { name: "HTML", link: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg", category: "frontend" },
  { name: "CSS", link: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-plain.svg", category: "frontend" },
  { name: "Sass", link: "https://raw.githubusercontent.com/devicons/devicon/master/icons/sass/sass-original.svg", category: "frontend" },
  { name: "Tailwind CSS", link: "https://www.vectorlogo.zone/logos/tailwindcss/tailwindcss-icon.svg", category: "frontend" },
  { name: "Bootstrap", link: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/bootstrap/bootstrap-plain.svg", category: "frontend" },
  ...
  { name: "Python", link: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg", category: "backend" },
  { name: "Java", link: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg", category: "backend" },
  { name: "GO", link: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/go/go-original.svg", category: "backend" },
  { name: "Ruby", link: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/ruby/ruby-original.svg", category: "backend" },
  { name: "NodeJS", link: "https://raw.githubusercontent.com/devicons/devicon/master/icons/nodejs/nodejs-original-wordmark.svg", category: "backend" },
  { name: "Mongo DB", link: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mongodb/mongodb-plain.svg", category: "backend" },
  { name: "MySQL", link: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original-wordmark.svg", category: "backend" },

  // 📦 Framework
  { name: "Symfony", link: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/symfony/symfony-original.svg", category: "framework" },
  { name: "Laravel", link: "https://cdn.worldvectorlogo.com/logos/laravel-2.svg", category: "framework" },
  { name: "Express", link: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/express/express-original-wordmark.svg", category: "framework" },
  { name: "Next.js", link: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nextjs/nextjs-line.svg", category: "framework" },

  // 🛠️ Tools
  { name: "Git", link: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-plain.svg", category: "tools" },
...
/* export const techStack = [
  ...
  { name: "GO", link: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/go/go-original.svg" },
 ...
 // { name: "Heroku", link: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/heroku/heroku-plain.svg" },
  ...
  { name: "jQuery", link: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/jquery/jquery-original.svg" },
